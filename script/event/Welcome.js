...
module.exports.handleEvent = async function ({ api, event }) {
    if (event.logMessageType === "log:subscribe") {
        ...
        const url = `https://hershey-apis.onrender.com/api/welcome?username=${encodeURIComponent(name)}&avatarUrl=https://api-rynx.onrender.com/api/profile?uid=${senderID}&groupname=${encodeURIComponent(groupName)}&bg=${encodeURIComponent(background)}&memberCount=${memberCount}`;
