...
module.exports.handleEvent = async function ({ api, event }) {
    if (event.logMessageType === "log:unsubscribe") {
        ...
        const url = `https://hershey-apis.onrender.com/api/goodbye?pp=https://api-canvass.vercel.app/profile?uid=${leftID}&name=${encodeURIComponent(name)}&bg=${encodeURIComponent(background)}&member=${memberCount}`;
