...
module.exports.config = {
  ...
  version: "1.0.0",
  credits: "Ry",
  description: "Ask anything to Yi model from 01.AI",
  usage: "yi <question>",
  cooldown: 3,
  role: 0,
  hasPrefix: false,
...
module.exports.run = async function ({ api, event, args }) {
  ...
  api.sendMessage(formatFont("🤖 𝗬𝗜 𝗜𝗦 𝗣𝗥𝗢𝗖𝗘𝗦𝗦𝗜𝗡𝗚..."), threadID, async (err, info) => {
    if (err) return;
    ...
    try {
      ...
      const reply = data.response || "❌ No response received from Yi.";
